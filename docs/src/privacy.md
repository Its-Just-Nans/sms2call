...
*   **Application** refers to Sms2Call, the software program provided by the Company.
    
*   **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Sms2Call.
...
*   By visiting this page on our website: [https://sms2call.n4n5.dev/](https://sms2call.n4n5.dev/)
